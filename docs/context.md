...
|------|------|
|**Mercado de trabalho:** Aumentar a acessibilidade pode criar oportunidades de emprego para pessoas com deficiência, aumentando a diversidade no mercado de trabalho.|**Falta de recurso financeiro**: Para algumas empresas, o custo de tornar-se um ambiente acessível pode ser uma ameaça financeira.|
|**Mercado consumidor**: Produtos e serviços acessíveis pode ampliar a base de clientes, já que pessoas com deficiência e suas redes podem representar um grande mercado consumidor.|**Concorrência**: A concorrência pode não estar adotando medidas de acessibilidade, o que pode prejudicar empresas que investem nessa área.|
...
|**Responsabilidade social:** Empresas que promovem a acessibilidade podem melhorar sua imagem e reputação, o que pode atrair clientes e investidores.|**Falta de consciência**: A falta de conscientização contínua sobre a acessibilidade de Pessoas com deficiência pode perpetuar a exclusão e a discriminação dessas indivíduos na sociedade.|

O motivo da escolha do tema desse trabalho é de examinar os caráteres sociais e econômicos exclusivos que recaem sobre os deficientes e expressar a maneira como isso afeta suas vidas com base em suas próprias perspectivas. O projeto mostra isso através de das dores comentadas pelos indivíduos e quais são suas principais dificuldades diárias em questões de facilidade de acesso e interação com informações e recursos, apresentando conceitos de falhas estruturais tanto física quanto digital, e meios para combater a negligência informativa com relação aos problemas enfrentados por deficientes. As explicações foram obtidas por meio tanto por meio de dados concretos a respeito de acessibilidade quanto posicionamento das próprias pessoas afetadas, o que fortalece a forma de imersão na realidade das mesmas.

Os objetivos específicos foram escolhidos com um foco em analisar e combater os problemas apresentados com base em informações concretas e coerentes simultaneamente ao apontamento de fatores relevantes no estilo de vida de PcDs. O software a ser desenvolvido, portanto, teria como ponto muito relevante a metodologia de avaliação, pois esse recurso permite uma visualização de como o destinatário deficiente enxerga as condições de suporte do serviço oferecido. Assim sendo, a questão de que seja possível avaliar o lugar seria um ponto muito crucial para o desenvolvimento do projeto, uma vez que com isso a fidelidade da avaliação em si e dos problemas a serem resolvidos será mais precisa, além de que a empresa passará a ter maior contato com relação à sociedade PcD e consequentemente perceberá mais a respeito de suas principais dificuldades, algo que irá contribuir para a inclusão dos deficientes no meio. Acreditamos que os problemas a serem resolvidos podem ser mais precisamente obtidos através da opinião da comunidade PcD e obtenção de dados. A imersão na vida de um deficiente auxilia no aprofundamento dos reais problemas enfrentados pelos mesmo através da visualização de sua perspectiva, e simultaneamente os dados comprovam essa realidade e fornecem valores brutos para que se tenha uma ideia objetiva do campo a ser abrangido na resolução do problema.
